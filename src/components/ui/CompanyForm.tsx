...
import { DemoNotice, IS_DEMO_MODE } from "../DemoComponents";
...
export default function ClientForm({ form, setForm, onSave, onCancel }: ClientFormProps) {
  const handleDemoSave = () => {
    if (IS_DEMO_MODE) {
      alert("Demo Mode: Company save operation simulated. In the full application, this would save the data to the server.");
  ...
  return (
    <div className="relative">
      {IS_DEMO_MODE && <DemoNotice action="Company Save" />}
